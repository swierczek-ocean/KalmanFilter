function enkfsr3r(dt,ensemble,M,N,H,t_final,R,Y,jump,r,alpha,spy)
tic();
...
title(['Observed Data vs. SRRR1 Kalman Estimate in coordinate ', num2str(spy)])
xlabel('time')
legend('Kalman','Observed')
print(['KalmanvsObs_SRRR1_r=',num2str(r),'_alpha=',num2str(alpha),'_Ne=',num2str(ne)],'-djpeg')
